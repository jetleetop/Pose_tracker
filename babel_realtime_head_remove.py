...
OUTPUT_PATH     = os.path.join(BASE_DIR, 'video', 'realtime_dead_test1.mp4')
...
while True:
    ...
    # 9.5) 텍스트 오버레이
    cv2.putText(frame,
                f"Squat  T={total_reps['squat']}  C={correct_reps['squat']}",
                (10,30),  cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255,255,255), 2)
    cv2.putText(frame,
                f"Deadlift  T={total_reps['deadlift']}  C={correct_reps['deadlift']}",
                (10,60),  cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255,255,255), 2)
    cv2.putText(frame,
                f"Exercise: {exe_key}", (10,90),  cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255,255,255), 2)
    cv2.putText(frame,
                f"Phase: {phase}",      (10,120), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255,255,255), 2)
